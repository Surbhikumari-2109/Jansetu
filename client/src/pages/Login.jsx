          ...
          // 🛑 STRIKE 2: Public/Citizen Portal Validation
            ...
            if (isLogin) {
              if (loggedInRole !== 'citizen') {
                alert('Access Denied: Officials cannot log in through the Public Citizen Portal.');
                localStorage.clear();
                return;
              }
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div className="flex items-center justify-end pt-1">
                  <div className="text-sm">
                    <Link to="/forgot-password" className="font-bold text-orange-600 hover:text-orange-500 cursor-pointer outline-none">
                      Forgot password?
                    </Link>
                  </div>
                </div>
