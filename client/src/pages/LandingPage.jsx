      ...
      <header className="bg-white/80 backdrop-blur-md border-b border-slate-200/80 sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <button 
            ...
            className="md:hidden text-slate-600 p-2 rounded-xl hover:bg-slate-100 transition-colors cursor-pointer"
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-slate-200/60 bg-white px-6 py-6 flex flex-col gap-4 shadow-xl">
            ...
            <div className="flex flex-col gap-3 mt-2">
               <Link to="/login" className="text-center w-full text-slate-600 border border-slate-200 py-3 rounded-xl font-bold text-sm uppercase tracking-wider">Sign In</Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <div className="text-sm font-bold text-slate-400 flex items-center gap-2">
                <PhoneCall className="h-4 w-4 text-slate-400" /> Helpline: 1800-XXX-XXXX (Toll Free)
              </div>
            </div>
